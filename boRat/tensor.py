...
def bond_transformation(a):
    ...
    bond2 = np.array([[l11**2, l12**2, l13**2, 2*l12*l13, 2*l13*l11, 2*l12*l11],
                      [l21**2, l22**2, l23**2, 2*l23*l22, 2*l23*l21, 2*l22*l21],
                      [l31**2, l32**2, l33**2, l33*l32, l33*l31, l32*l31],
                      [l31*l21, l32*l22, l33*l23, l33*l22+l32*l23, l33*l21+l31*l23, l31*l22+l32*l21],
                      [l31*l11, l32*l12, l33*l13, l33*l12+l32*l13, l33*l11+l31*l13, l31*l12+l32*l11],
                      [l21*l11, l12*l22, l13*l23, l13*l22+l12*l23, l13*l21+l11*l23, l11*l22+l12*l21]])
    ...
    bond = np.array([[l11**2, l12**2, l13**2, l12*l13, l13*l11, l12*l11],
                     ...
                     [l31**2, l32**2, l33**2, l33*l32, l33*l31, l32*l31],
                     [2*l31*l21, 2*l32*l22, 2*l33*l23, l33*l22+l32*l23, l33*l21+l31*l23, l31*l22+l32*l21],
                     [2*l31*l11, 2*l32*l12, 2*l33*l13, l33*l12+l32*l13, l33*l11+l31*l13, l31*l12+l32*l11],
                     [2*l21*l11, 2*l12*l22, 2*l13*l23, l13*l22+l12*l23, l13*l21+l11*l23, l11*l22+l12*l21]])
...
class TensorVoigt:
    ...
    def rot(self, mode, x=0, y=0, z=0):
        ...
        bt_matrix = bond_transformation(rotation_matrix)
        rotated = TensorVoigt()
